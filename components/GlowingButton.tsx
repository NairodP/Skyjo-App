...
export default function GlowingButton({ href, children }: GlowingButtonProps) {
  return (
    <Link href={href} className="inline-block">
      <button className="group relative inline-flex h-14 overflow-hidden rounded-full p-[5px] focus:outline-none focus:ring-2 focus:ring-[#7a47ff] focus:ring-offset-2 focus:ring-offset-[#0b000c]">
